...
{
    public partial class Finger_Print_Comparison : Form
    {
        public Finger_Print_Comparison(IMatcher matcher, IResourceProvider resourceProvider, string resourcePath)
        {
            InitializeComponent();
        ...
        #endregion
        private void Finger_Print_Comparison_Load(object sender, EventArgs e)
        {
        ...
        {
            Extract_Fingerprint ext = new Extract_Fingerprint();
            ext.Show();
        }
